...
namespace TruckSys.Presentation
{
    public class TrucksController : Controller
    {
        private readonly Tru _context;

        public TrucksController(TruckSysPresentationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TruckSysPresentationContext.Truck'  is null.");
            }
            var truck = await _context.Truck.FindAsync(id);
            if (truck != null)
            {
